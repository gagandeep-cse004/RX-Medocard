...
// ✅ Fetch user details including both serials
$stmt = $con->prepare("SELECT name, card_type, card_validity, purchase_date, serial_no_medocard, serial_no_insure FROM mydata WHERE id = ?");
$stmt->bind_param("i", $user_id);
$stmt->execute();
$stmt->bind_result($name, $card_type, $card_validity, $purchase_date, $serial_medo, $serial_insure);
$stmt->fetch();
$stmt->close();
$con->close();

// ✅ Smart card number selection
$card_no = !empty($serial_medo) ? $serial_medo : (!empty($serial_insure) ? $serial_insure : '');

// ✅ Validity calculation block
...
@media (min-width: 769px) {
  ...
  overflow-y: scroll;   /* Always visible on desktop */
  }
  .mobile-header {
...
<body>
  ...
  <div class="sidebar" id="sidebar">
    ...
    <button class="menu-btn" onclick="showSection('Services', this)">Book Services</button>
  ...
  <div class="main-content">
        ...
        <div class="services-box fade-in-delay-2">
          ...
          <div class="services-card-wrapper">
            ...
            <div class="image-slider">
              <img src="yellowcardfront.jpg" class="slide">
              <img src="yellowcardback.jpg" class="slide">
              <img src="bluecardfront.jpg" class="slide">
              <img src="bluecardback .jpg" class="slide">
            </div>
    ...
    <div id="membership" class="content-section">
      <div class="modern-card-section family-plans-card">
        <h2 class="section-title">Family Plans</h2>
      ...
      <div style="display: flex;gap: 10px;margin-top: 40px;" class="hsp">
        ...
        <div class="hospital-cards-container row g-4">
            ...
            <div class="hospital-card">
              ...
              <div class="hospital-card-content">
                ...
                <div class="hospital-card-location">
                  <i class="bi bi-geo-alt-fill"></i> Parthala Chowk, PKC-12, Sector- 122, Noida, India
                </div>
          ...
          <div class="col-lg-4 col-md-6">
            <div class="hospital-card">
              <div class="hospital-card-img-container">
                <img src="sarvodaya hospital sector19.jpg" alt="Sarvodaya Hospital Sector 19" class="hospital-card-img">
                <div class="hospital-card-overlay"></div>
                <div class="hospital-card-rating">
                  <i class="bi bi-star-fill"></i> 4.4
                </div>
          ...
          <div class="col-lg-4 col-md-6">
            <div class="hospital-card">
              <div class="hospital-card-img-container">
                <img src="felix hospital greter noida.jpg" alt="Felix Hospital Greater Noida" class="hospital-card-img">
                <div class="hospital-card-overlay"></div>
                <div class="hospital-card-rating">
                  <i class="bi bi-star-fill"></i> 4.5
                </div>
      ...
      <section class="recommended">
        ...
        <div class="hospital-grid">
          ...
          <div class="hospital-box">
            <img style="height: 250px;" src="image.png" alt="MD City Hospital" />
            <h3>MD City Hospital</h3>
            <p><b>Address:</b> Parthala Chowk, PKC-12, Sector- 122, Noida, India</p>
          ...
          <!-- Sarvodaya Hospital -->
          <div class="hospital-box">
            <img style="height: 250px;" src="sarvodaya hospitalgreaternoida.jpg" alt="Sarvodaya Hospital" />
         ...
         <option value="Radiology">Radiology</option>
          ...
          <div id="appointment_time_block">
            ...
            <select id="appointment_time" name="appointment_time" required>
             ...
             <p><b>Disclaimer - </b>The doctor will contact you in your selected time</p>
          </div>
      
          <!-- Prescription upload -->
          <label for="prescription_image">Prescription (Please upload your previous prescription)</label>
          <input type="file" id="prescription_image" name="prescription_image" accept="image/*,application/pdf" required>
